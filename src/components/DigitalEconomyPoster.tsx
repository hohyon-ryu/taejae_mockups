    ...
    <div className="bg-white p-4 w-full">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-4 bg-white rounded-lg shadow-md overflow-hidden">
          <div className="bg-gray-900 text-white p-2 relative overflow-hidden">
          ...
          <div className="p-3">
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-gray-50 p-2 rounded-lg border-l-4 border-green-500">
                <h3 className="text-lg font-bold text-gray-800 mb-1">현재: 노동 중심</h3>
              ...
              <div className="bg-gray-50 p-2 rounded-lg border-l-4 border-gray-400">
                <h3 className="text-lg font-bold text-gray-800 mb-1">미래: 관심 중심</h3>
                <ul className="text-base space-y-1 text-gray-700">
        ...
        <div className="mb-4 bg-white rounded-lg shadow-md overflow-hidden">
          <div className="bg-gray-900 text-white p-2 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h2 className="text-xl font-bold">2. 경제 질서 변화 비교</h2>
            </div>
          </div>
          ...
          <div className="p-3">
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-gray-50 p-2 rounded-lg border-l-4 border-gray-400">
                <h3 className="text-lg font-bold text-gray-800 mb-1">전통 시대 (산업 시대)</h3>
              ...
              <div className="bg-gray-50 p-2 rounded-lg border-l-4 border-green-500">
                <h3 className="text-lg font-bold text-gray-800 mb-1">디지털/AI/관심 경제 시대</h3>
                <ul className="text-base space-y-0.5 text-gray-700">
          ...
          <div className="p-3">
            <div className="grid grid-cols-3 gap-2">
              <div className="bg-gray-50 p-2 rounded-lg">
                <h3 className="text-base font-bold text-gray-800">개인</h3>
                <p className="text-base text-gray-700">자아의 상품화, 정체성이 '좋아요'와 '팔로워' 수로 측정</p>
              </div>
              
              <div className="bg-gray-50 p-2 rounded-lg">
                <h3 className="text-base font-bold text-gray-800">가정</h3>
                <p className="text-base text-gray-700">가족 시간이 디지털 플랫폼과 경쟁, 가정생활의 콘텐츠화</p>
              </div>
              
              <div className="bg-gray-50 p-2 rounded-lg">
                <h3 className="text-base font-bold text-green-700">이웃</h3>
                <p className="text-base text-gray-700">물리적 근접성보다 공통 관심사 중심의 공동체 형성</p>
              </div>
              
              <div className="bg-gray-50 p-2 rounded-lg">
                <h3 className="text-base font-bold text-gray-800">기업</h3>
                <p className="text-base text-gray-700">소셜 미디어, AI, 검색 엔진의 부상과 영향력 확대</p>
              </div>
              
              <div className="bg-gray-50 p-2 rounded-lg">
                <h3 className="text-base font-bold text-gray-800">도시</h3>
                <p className="text-base text-gray-700">관심 중심 도시 공간 재구성, 디지털 공간으로 확장</p>
              </div>
              
              <div className="bg-gray-50 p-2 rounded-lg">
                <h3 className="text-base font-bold text-gray-800">국가/글로벌</h3>
                <p className="text-base text-gray-700">플랫폼과 국가 간 주권 경쟁, 데이터 패권과 안보화</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-4 bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-3">
            <div className="grid grid-cols-3 gap-2">
              <div className="bg-gray-50 p-2 rounded-lg border-l-4 border-gray-400">
                <h3 className="text-base font-bold text-gray-800">디지털 건강 위기</h3>
                <p className="text-base text-gray-700">관심 경쟁과 알림 폭격으로 수면장애, 주의력 결핍 증가</p>
              </div>
              
              <div className="bg-gray-50 p-2 rounded-lg border-l-4 border-gray-400">
                <h3 className="text-base font-bold text-gray-800">사회적 단절 심화</h3>
                <p className="text-base text-gray-700">온라인 집단으로 이동, 사회적 유대 약화</p>
              </div>
              
              <div className="bg-gray-50 p-2 rounded-lg border-l-4 border-green-500">
                <h3 className="text-base font-bold text-gray-800">민주주의 기능 약화</h3>
                <p className="text-base text-gray-700">선정적 정치 담론 확산, 사회적 합의 능력 저하</p>
              </div>
              
              <div className="bg-gray-50 p-2 rounded-lg border-l-4 border-gray-400">
                <h3 className="text-base font-bold text-gray-800">경제적 안전망 붕괴</h3>
                <p className="text-base text-gray-700">노동 중심 설계된 복지 시스템의 부적합성</p>
              </div>
              
              <div className="bg-gray-50 p-2 rounded-lg border-l-4 border-gray-400">
                <h3 className="text-base font-bold text-gray-800">인지 주권 상실</h3>
                <p className="text-base text-gray-700">알고리즘 조작으로 자율적 의사결정 침해</p>
              </div>
              
              <div className="bg-gray-50 p-2 rounded-lg border-l-4 border-gray-400">
                <h3 className="text-base font-bold text-gray-800">기술 불평등 심화</h3>
        ...
        <div className="mb-4 bg-white rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-3">
            <div className="grid grid-cols-3 gap-2">
              <div className="bg-gray-50 p-2 rounded-lg">
                <h3 className="text-base font-bold text-gray-800 mb-1">AS-IS</h3>
                <ul className="text-base space-y-0.5 text-gray-700">
              ...
              <div className="bg-gray-50 p-2 rounded-lg">
                <h3 className="text-base font-bold text-gray-800 mb-1">TO-BE</h3>
                <ul className="text-base space-y-0.5 text-gray-700">
              ...
              <div className="bg-gray-50 p-2 rounded-lg">
                <h3 className="text-base font-bold text-green-700 mb-1">TO-DO</h3>
